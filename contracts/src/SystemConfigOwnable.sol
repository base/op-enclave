...
contract SystemConfigOwnable is OwnableConfig, ISemver, IGasToken {
    ...
    function _setUnsafeBlockSigner(address _unsafeBlockSigner) internal {
        ...
        emit ConfigUpdate(VERSION, SystemConfig.UpdateType.UNSAFE_BLOCK_SIGNER, data);
    }
    ...
    function _setBatcherHash(bytes32 _batcherHash) internal {
        ...
        emit ConfigUpdate(VERSION, SystemConfig.UpdateType.BATCHER, data);
    }
    ...
    function _setGasConfig(uint256 _overhead, uint256 _scalar) internal {
        ...
        emit ConfigUpdate(VERSION, SystemConfig.UpdateType.GAS_CONFIG, data);
    }
    ...
    function _setGasLimit(uint64 _gasLimit) internal {
        ...
        emit ConfigUpdate(VERSION, SystemConfig.UpdateType.GAS_LIMIT, data);
    }
